...
export default function UnitOfMeasureForm(props) {
  ...
  const formName = "Unit Of Measure Form";
  ...
  const loadData = () => {
    const uomData = JSON.parse(localStorage.getItem("uomData"));
    ...
    for (const uom of uomData) {
      ...
      localStorage.removeItem("uomData");
      return existingData;
    }
  };
  ...
  const postItem = async () => {
    try {
      const result = await postData("/unit_of_measure", formData);
